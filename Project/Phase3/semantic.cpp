...
// ;
    ...
    Node *type = specifier->children[0];
    ...
    {
        Node *_struct = type->children[0];
        Node *struct_id = type->children[1];
...
SemanticType *analyze_args(Node *args, SemanticType *func_type, Node *id) //?nextnode
{
